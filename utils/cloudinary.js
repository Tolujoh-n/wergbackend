...
cloudinary.config({
  cloud_name: process.env.CLOUDINARY_CLOUD_NAME || 'de2qwywgg',
  api_key: process.env.CLOUDINARY_API_KEY || '999146379287148',
  api_secret: process.env.CLOUDINARY_API_SECRET || 'DLRrkG26TcCI3vbE5ENid_QgLAs'
});
